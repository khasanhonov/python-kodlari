...
# class Bajarilgan(ToDoList):

#     def __init__(self, fayl_nomi="todo_list.txt", bajarigan):
#         super().__init__(fayl_nomi, Vazifalar, yukla)
#         self.bajarigan = bajarilgan
#      def bejarilgan_vazifalar(self):
#         if not self.vazifalar:
#             print("Xali xech narsani bajarilmagan")
#             return
#         print("\nBajarilganlar:")
#         if self.vazifalar:    
#             for i, vazifa in enumerate(self.vazifalar, 1):
#                 holat = "nomi" if vazifa["bajarilgan"]

# class Bajarilmagan()                                          xato kod yozdim!
